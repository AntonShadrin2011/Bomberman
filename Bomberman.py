...
class MyGame(arcade.Window):
    def __init__(self, width, height, title):
        ...
        self.bloki = 7  # 🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥 поменяй это число на какое-то другое и посмотри результат
...
"""
Сделать проигрыш + победу
В один из папок есть две картинки (плеер 1 вин, плеер 2 вин) - отрисовать их по какому-то событию (подумать когда)

2.Если не супер тяжело будет, то добавить анимации для бомбочек + огней, чтобы игра смотрелась более живой
